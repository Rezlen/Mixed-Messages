...
function rotateVerses() {
    document.getElementById('verses').style.opacity = 0;
    setTimeout(function() {
        let rand1 = Math.floor(Math.random() * verses.length)
        let rand2 = Math.floor(Math.random() * verses.length)
        let rand3 = Math.floor(Math.random() * verses.length)
        if (rand1 === rand2 || rand1 === rand3 || rand2 === rand3) {
            while (rand1 === rand2 || rand1 === rand3 || rand2 === rand3) {
                rand1 = Math.floor(Math.random() * verses.length)
                rand2 = Math.floor(Math.random() * verses.length)
                rand3 = Math.floor(Math.random() * verses.length)
            }
        }
        let verse1 = verses[rand1]
        let verse2 = verses[rand2]
        let verse3 = verses[rand3]
        ...
        document.getElementById('verses').style.opacity = 1;    
    }, 500)
}
...
button.addEventListener('click', rotateVerses)
